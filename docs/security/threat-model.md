...
| Credential or KUR workload key rotation mid-transaction | Record each Secret UID and resourceVersion before the first message and stop an unfinished transaction before more CMP traffic when any identity changes |
