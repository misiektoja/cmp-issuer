...
| github.com/prometheus/client_golang | v1.24.1 | Apache-2.0 | Counter and histogram types for the enrollment metrics, registered on the controller-runtime metrics registry |
