...
*/}}
{{- define "cmp-issuer.namespaceName" -}}
{{- .Release.Namespace }}
{{- end }}
...
*/}}
{{- define "cmp-issuer.resourceName" -}}
{{- $fullname := include "cmp-issuer.fullname" .context }}
{{- $suffix := .suffix }}
